...
namespace bronskiycraftsolpaceexpressformstelegram\craftsolspaceexpressformstelegramnotifications;
...
*
*/
class CraftSolspaceExpressFormsTelegramNotifications extends Plugin
{
  // Static Properties
  // =========================================================================
  ...
  *
  * @var CraftSolspaceExpressFormsTelegramNotifications
  */
  ...
  */
  public function init()
  {
    ...
    Event::on(
      ...
      function (SaveSubmissionEvent $event) {
        ...
        foreach ($form->getFields() as $field) {
          $telegram_message .= $field->getName() . ': ' . $field->getValue() . ". \n";
        }

        $ch = curl_init(getenv('TELEGRAM_API'));
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($ch, CURLOPT_TIMEOUT, 3);
        curl_setopt($ch, CURLOPT_HEADER, 0);
        curl_setopt($ch, CURLOPT_POSTFIELDS, array(
          "chat_id" => '-1001449075259',
    ...
    */
    Craft::info(
      Craft::t(
        'craft-solspace-express-forms-telegram-notifications',
        '{name} plugin loaded',
        ['name' => $this->name]
      ),
      __METHOD__
